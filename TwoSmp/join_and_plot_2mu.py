    ...
    if simNo in [23,24]:
        ...
        for f in f_values:
            ...
            for p in p_values:
                ...
                # n and p for this fwhm
                n_est_f = table_est_g[['n']].values
                p_est_f = table_est_g[['p='+('%.2f' % p)]].values
                n_true_f = table_true_g[['n']].values
                p_true_f = table_true_g[['p='+('%.2f' % p)]].values
