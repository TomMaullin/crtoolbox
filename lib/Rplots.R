  ...
  for(simNumbers in simNoArray){
    ...
    if (simNumbers=='1-2'){
      ...
      sim1_d_vs_cov <- ggplot(tmp, aes(x=`Distance`,y=.data[[toString(p)]], group=`n`, color=`n`)) + 
        ...
        labs(title = 'Simulation 2: Circles Moving (High SNR)', subtitle = paste('Distance vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Distance Between Circle Centers (Number of Pixels)', y = 'Observed Coverage')
      ...
      sim1_n_vs_cov <- ggplot(tmp, aes(x=`n`,y=.data[[toString(p)]], group=`Distance`, color=`Distance`)) + 
        ...
        labs(title = 'Simulation 2: Circles Moving (High SNR)', subtitle = paste('Number of Observations vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Observations', y = 'Observed Coverage')
      ...
      sim2_d_vs_cov <- ggplot(tmp, aes(x=`Distance`,y=.data[[toString(p)]], group=`n`, color=`n`)) + 
        ...
        geom_line(aes(x=`Distance`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`Distance`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 1: Circles Moving (Low SNR)', subtitle = paste('Distance vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Distance Between Circle Centers (Number of Pixels)', y = 'Observed Coverage')
      ...
      sim2_n_vs_cov <- ggplot(tmp, aes(x=`n`,y=.data[[toString(p)]], group=`Distance`, color=`Distance`)) + 
        ...
        geom_line(aes(x=`n`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`n`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 1: Circles Moving (Low SNR)', subtitle = paste('Number of Observations vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Observations', y = 'Observed Coverage')
      ...
      png(filename = paste('/home/tommaullin/Documents/ConfRes/FinalSims/', toString(100*p), '/', bdryType ,'/sim1and2.png', sep = ''), width = 1800, height = 1000,
    ...
    if (simNumbers=='7-8'){
      ...
      sim7_d_vs_cov <- ggplot(tmp, aes(x=`Distance`,y=.data[[toString(p)]], group=`n`, color=`n`)) + 
        ...
        geom_line(aes(x=`Distance`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`Distance`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 4: Squares Moving (High SNR)', subtitle = paste('Distance vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Distance Between Square Centers (Number of Pixels)', y = 'Observed Coverage')
      ...
      sim7_n_vs_cov <- ggplot(tmp, aes(x=`n`,y=.data[[toString(p)]], group=`Distance`, color=`Distance`)) + 
        ...
        geom_line(aes(x=`n`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`n`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 4: Squares Moving (High SNR)', subtitle = paste('Number of Observations vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Observations', y = 'Observed Coverage')
      ...
      sim8_d_vs_cov <- ggplot(tmp, aes(x=`Distance`,y=.data[[toString(p)]], group=`n`, color=`n`)) + 
        ...
        geom_line(aes(x=`Distance`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`Distance`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 3: Squares Moving (Low SNR)', subtitle = paste('Distance vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Distance Between Square Centers (Number of Pixels)', y = 'Observed Coverage')
      ...
      sim8_n_vs_cov <- ggplot(tmp, aes(x=`n`,y=.data[[toString(p)]], group=`Distance`, color=`Distance`)) + 
        ...
        geom_line(aes(x=`n`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`n`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 3: Squares Moving (Low SNR)', subtitle = paste('Number of Observations vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Observations', y = 'Observed Coverage')
      ...
      png(filename = paste('/home/tommaullin/Documents/ConfRes/FinalSims/', toString(100*p), '/', bdryType ,'/sim3and4.png', sep = ''), width = 1800, height = 1000,
          units = "px", pointsize = 12, bg = "white", res = 120)
    ...
    if (simNumbers=='11-12'){
      ...
      sim11_d_vs_cov <- ggplot(tmp, aes(x=`Distance`,y=.data[[toString(p)]], group=`n`, color=`n`)) + 
        ...
        geom_line(aes(x=`Distance`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`Distance`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 6: Squares Moving, Heterogeneous Noise (High SNR)', subtitle = paste('Distance vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Distance Between Square Centers (Number of Pixels)', y = 'Observed Coverage')
      ...
      sim11_n_vs_cov <- ggplot(tmp, aes(x=`n`,y=.data[[toString(p)]], group=`Distance`, color=`Distance`)) + 
        ...
        geom_line(aes(x=`n`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`n`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 6: Squares Moving, Heterogeneous Noise (High SNR)', subtitle = paste('Number of Observations vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Observations', y = 'Observed Coverage')
      ...
      sim12_d_vs_cov <- ggplot(tmp, aes(x=`Distance`,y=.data[[toString(p)]], group=`n`, color=`n`)) + 
        ...
        geom_line(aes(x=`Distance`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`Distance`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 5: Squares Moving, Heterogeneous Noise (Low SNR)', subtitle = paste('Distance vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Distance Between Square Centers (Number of Pixels)', y = 'Observed Coverage')
      ...
      sim12_n_vs_cov <- ggplot(tmp, aes(x=`n`,y=.data[[toString(p)]], group=`Distance`, color=`Distance`)) + 
        ...
        geom_line(aes(x=`n`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`n`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 5: Squares Moving, Heterogeneous Noise (Low SNR)', subtitle = paste('Number of Observations vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Observations', y = 'Observed Coverage')
      ...
      png(filename = paste('/home/tommaullin/Documents/ConfRes/FinalSims/', toString(100*p), '/', bdryType ,'/sim5and6.png', sep = ''), width = 1800, height = 1000,
          units = "px", pointsize = 12, bg = "white", res = 120)
    ...
    if (simNumbers=='15-16'){
      ...
      sim15_d_vs_cov <- ggplot(tmp, aes(x=`Distance`,y=.data[[toString(p)]], group=`n`, color=`n`)) + 
        geom_ribbon(aes(ymin=p-bin_conf, ymax=p+bin_conf), alpha=0.05, fill='turquoise4', colour = NA) + geom_line() + 
        xlim(0,46) + ylim(2*p-1,1) + 
        scale_color_manual(values = c('100' = 'salmon','300' = 'darkorchid','500' = 'slategray'), name = 'n') +
        geom_line(aes(x=`Distance`,y=`truep`),linetype="dashed",color="black",size=0.1) +
        geom_line(aes(x=`Distance`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`Distance`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 8: Squares Moving, One Smaller (High SNR)', subtitle = paste('Distance vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Distance Between Square Centers (Number of Pixels)', y = 'Observed Coverage')
      ...
      sim15_n_vs_cov <- ggplot(tmp, aes(x=`n`,y=.data[[toString(p)]], group=`Distance`, color=`Distance`)) + 
        ...
        geom_line(aes(x=`n`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`n`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 8: Squares Moving, One Smaller (High SNR)', subtitle = paste('Number of Observations vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Observations', y = 'Observed Coverage')
      ...
      sim16_d_vs_cov <- ggplot(tmp, aes(x=`Distance`,y=.data[[toString(p)]], group=`n`, color=`n`)) + 
        ...
        geom_line(aes(x=`Distance`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`Distance`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 7: Squares Moving, One Smaller (Low SNR)', subtitle = paste('Distance vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Distance Between Square Centers (Number of Pixels)', y = 'Observed Coverage')
      ...
      sim16_n_vs_cov <- ggplot(tmp, aes(x=`n`,y=.data[[toString(p)]], group=`Distance`, color=`Distance`)) + 
        ...
        geom_line(aes(x=`n`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`n`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 7: Squares Moving, One Smaller (Low SNR)', subtitle = paste('Number of Observations vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Observations', y = 'Observed Coverage')
      ...
      png(filename = paste('/home/tommaullin/Documents/ConfRes/FinalSims/', toString(100*p), '/', bdryType ,'/sim7and8.png', sep = ''), width = 1800, height = 1000,
          units = "px", pointsize = 12, bg = "white", res = 120)
    ...
    if (simNumbers=='17-18'){
      ...
      sim17_corr_vs_cov <- ggplot(tmp, aes(x=`Correlation`,y=.data[[toString(p)]], group=`n`, color=`n`)) + 
        ...
        labs(title = 'Simulation 10: Varying Correlation, Square Signal (High SNR)', subtitle = paste('Correlation vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Correlation Between Noise Fields', y = 'Observed Coverage')
      ...
      sim17_n_vs_cov <- ggplot(tmp, aes(x=`n`,y=.data[[toString(p)]], group=`Correlation`, color=`Correlation`)) + 
        ...
        geom_line(aes(x=`n`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`n`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 10: Varying Correlation, Square Signal (High SNR)', subtitle = paste('Number of Observations vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Observations', y = 'Observed Coverage')
      ...
      sim18_corr_vs_cov <- ggplot(tmp, aes(x=`Correlation`,y=.data[[toString(p)]], group=`n`, color=`n`)) + 
        ...
        geom_line(aes(x=`Correlation`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`Correlation`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 9: Varying Correlation, Square Signal (Low SNR)', subtitle = paste('Correlation vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Correlation Between Noise Fields', y = 'Observed Coverage')
      ...
      sim18_n_vs_cov <- ggplot(tmp, aes(x=`n`,y=.data[[toString(p)]], group=`Correlation`, color=`Correlation`)) + 
        ...
        geom_line(aes(x=`n`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`n`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 9: Varying Correlation, Square Signal (Low SNR)', subtitle = paste('Number of Observations vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Observations', y = 'Observed Coverage')
      ...
      png(filename = paste('/home/tommaullin/Documents/ConfRes/FinalSims/', toString(100*p), '/', bdryType ,'/sim9and10.png', sep = ''), width = 1800, height = 1000,
          units = "px", pointsize = 12, bg = "white", res = 120)
    ...
    if (simNumbers=='19-20'){
      ...
      sim19_grad_vs_cov <- ggplot(tmp, aes(x=`Gradient`,y=.data[[toString(p)]], group=`n`, color=`n`)) + 
        ...
        labs(title = 'Simulation 12: Varying Signal Gradient, Ramp Signal (High SNR)', subtitle = paste('Gradient vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Gradient (per 50 voxels)', y = 'Observed Coverage')
      ...
      sim19_n_vs_cov <- ggplot(tmp, aes(x=`n`,y=.data[[toString(p)]], group=`Gradient`, color=`Gradient`)) + 
        ...
        geom_line(aes(x=`n`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`n`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 12: Varying Signal Gradient, Ramp Signal (High SNR)', subtitle = paste('Number of Observations vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Observations', y = 'Observed Coverage')
      ...
      sim20_grad_vs_cov <- ggplot(tmp, aes(x=`Gradient`,y=.data[[toString(p)]], group=`n`, color=`n`)) + 
        geom_ribbon(aes(ymin=p-bin_conf, ymax=p+bin_conf), alpha=0.05, fill='turquoise4', colour = NA) + geom_line() + 
        xlim(0.5,3.5) + ylim(2*p-1,1) + 
        scale_color_manual(values = c('100' = 'salmon','300' = 'darkorchid','500' = 'slategray'), name = 'n') +
        geom_line(aes(x=`Gradient`,y=`truep`),linetype="dashed",color="black",size=0.1) +
        geom_line(aes(x=`Gradient`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`Gradient`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 11: Varying Signal Gradient, Ramp Signal (Low SNR)', subtitle = paste('Gradient vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Gradient (per 50 voxels)', y = 'Observed Coverage')
      ...
      sim20_n_vs_cov <- ggplot(tmp, aes(x=`n`,y=.data[[toString(p)]], group=`Gradient`, color=`Gradient`)) + 
        ...
        geom_line(aes(x=`n`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`n`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 11: Varying Signal Gradient, Ramp Signal (Low SNR)', subtitle = paste('Number of Observations vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Observations', y = 'Observed Coverage')
      ...
      png(filename = paste('/home/tommaullin/Documents/ConfRes/FinalSims/', toString(100*p), '/', bdryType ,'/sim11and12.png', sep = ''), width = 1800, height = 1000,
          units = "px", pointsize = 12, bg = "white", res = 120)
    ...
    if (simNumbers=='21-22'){
      ...
      sim21_corr_vs_cov <- ggplot(tmp, aes(x=`Magnitude`,y=.data[[toString(p)]], group=`n`, color=`n`)) + 
        ...
        labs(title = 'Simulation 14: Varying Noise Standard Deviation, Square Signal (High SNR)', subtitle = paste('Standard Deviation vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Standard Deviation of Second Noise Field', y = 'Observed Coverage')
      ...
      sim21_n_vs_cov <- ggplot(tmp, aes(x=`n`,y=.data[[toString(p)]], group=`Magnitude`, color=`Magnitude`)) + 
        ...
        geom_line(aes(x=`n`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`n`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 14: Varying Noise Standard Deviation, Square Signal (High SNR)', subtitle = paste('Number of Observations vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Observations', y = 'Observed Coverage')
      ...
      sim22_corr_vs_cov <- ggplot(tmp, aes(x=`Magnitude`,y=.data[[toString(p)]], group=`n`, color=`n`)) + 
        ...
        geom_line(aes(x=`Magnitude`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`Magnitude`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 13: Varying Noise Standard Deviation, Square Signal (Low SNR)', subtitle = paste('Standard Deviation vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Standard Deviation of Second Noise Field', y = 'Observed Coverage')
      ...
      sim22_n_vs_cov <- ggplot(tmp, aes(x=`n`,y=.data[[toString(p)]], group=`Magnitude`, color=`Magnitude`)) + 
        ...
        geom_line(aes(x=`n`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`n`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 13: Varying Noise Standard Deviation, Square Signal (Low SNR)', subtitle = paste('Number of Observations vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Observations', y = 'Observed Coverage')
      ...
      png(filename = paste('/home/tommaullin/Documents/ConfRes/FinalSims/', toString(100*p), '/', bdryType ,'/sim13and14.png', sep = ''), width = 1800, height = 1000,
          units = "px", pointsize = 12, bg = "white", res = 120)
    ...
    if (simNumbers=='M1-M2'){
      ...
      sim1_m_vs_cov <- ggplot(tmp, aes(x=`M`,y=.data[[toString(p)]], group=`n`, color=`n`)) + 
        ...
        labs(title = 'Simulation 16: Varying Number of Study Conditions (High SNR)', subtitle = paste('Number of Study Conditions vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Study Conditions (M)', y = 'Observed Coverage')
      ...
      sim1_n_vs_cov <- ggplot(tmp, aes(x=`n`,y=.data[[toString(p)]], group=`M`, color=`M`)) + 
        ...
        geom_line(aes(x=`n`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`n`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 16: Varying Number of Study Conditions (High SNR)', subtitle = paste('Number of Observations vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Observations', y = 'Observed Coverage')
      ...
      sim2_m_vs_cov <- ggplot(tmp, aes(x=`M`,y=.data[[toString(p)]], group=`n`, color=`n`)) + 
        ...
        geom_line(aes(x=`M`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`M`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 15: Varying Number of Study Conditions (Low SNR)', subtitle = paste('Number of Study Conditions vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Study Conditions (M)', y = 'Observed Coverage')
      ...
      sim2_n_vs_cov <- ggplot(tmp, aes(x=`n`,y=.data[[toString(p)]], group=`M`, color=`M`)) + 
        ...
        geom_line(aes(x=`n`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`n`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulation 15: Varying Number of Study Conditions (Low SNR)', subtitle = paste('Number of Observations vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Observations', y = 'Observed Coverage')
      ...
      png(filename = paste('/home/tommaullin/Documents/ConfRes/FinalSims/', toString(100*p), '/', bdryType ,'/sim15and16.png', sep = ''), width = 1800, height = 1000,
          units = "px", pointsize = 12, bg = "white", res = 120)
    ...
    if (simNumbers=='M3-M4'){
      ...
      sim34_n_vs_cov <- ggplot(finaldata, aes(x=`n`,y=.data[[toString(p)]], group=`Sim`, color=`Sim`)) + 
        ...
        geom_line(aes(x=`n`,y=`lowp`),linetype="dashed",color="gray65",size=0.1) +
        geom_line(aes(x=`n`,y=`uppp`),linetype="dashed",color="gray65",size=0.1) +
        labs(title = 'Simulations 17 and 18: Nested Squares', subtitle = paste('Number of Observations vs Observed Coverage, p = ', toString(p), ', ', bdryStr, sep=''), x = 'Number of Observations', y = 'Observed Coverage')
      ...
      png(filename = paste('/home/tommaullin/Documents/ConfRes/FinalSims/', toString(100*p), '/', bdryType ,'/sim17and18.png', sep = ''), width = 900, height = 500,
          units = "px", pointsize = 12, bg = "white", res = 120)
